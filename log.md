...
**Today's Progress:**  
- NovaForge
  - Improvements to particle color material for efficiency and better visuals
  - Added close gravity field to space warps so that particles don't orbit forever
  - Fixed stats updating, fixed UI, fixed pause and resume, changed sim speed intervals
  - Changed starting sim speed from 1 to 2.5
  - Completely removed all UIBuilder packages and related files
  - Reduced build size by tweaking some texture compression and music quality
...
## R5-D71: June 7, 2020 - Sunday

**Today's Progress:**  
- NovaForge
  - Dusted off the project and updated to Unity v2020.1.0v11.3880, tested a few things, made notes on fixes needed
- Covid-19 (Coronavirus) Analytics
  - Updated stats for the day as usual
...
## R5-D70: June 6, 2020 - Saturday

**Today's Progress:**  
- Automate the Boring Stuff with Python
  - Ch 11: Web Scraping
    - Completed mapit.py and requests_test.py in Web Scraping chapter
    - Finished save_downloaded_data for Romeo & Juliet

**Thoughts:**  
Working on a personal project where I need to scrape data from a website.  Cracked open the Automate the Boring Stuff with Python book to refresh.

**Link(s) to work:**
1. [Automate the Boring Stuff with Python - Completed mapit.py and requests_test.py in Web Scraping chapter](https://github.com/BrianLeip/Automate_With_Python/blob/00ceb377251eb4559c39df2bb7365abe9b8ab62e/11-Web%20Scraping/mapit.py)
2. [Automate the Boring Stuff with Python - Finished save_downloaded_data for Romeo & Juliet](https://github.com/BrianLeip/Automate_With_Python/blob/3826e9121d3a27338d0c4ce090cc6338e15c6fcd/11-Web%20Scraping/save_downloaded_data.py)

---

## R5-Dxx: June 4 & 5, 2020 - Thursday & Friday

**Thoughts:**  
Taking a little time off from coding to focus on other priorities.

---

## R5-D69: June 3, 2020 - Wednesday
...
**Link(s) to work:**
1. [FCC: Responsive Web Design: Applied Visual Design - 5 more exercises](https://github.com/BrianLeip/FCC-Responsive-Web-Design/commit/b470053d8492fc33fa23122313d5682f88f8e64a)
2. [Covid-19 Analytics - Updated stats for the day](https://github.com/BrianLeip/Covid19_Analytics/blob/f5e72a2f076cb503d1d06c368c8720c0303ba5b0/Covid19_Analytics.ipynb)

---

## R5-D68: June 2, 2020 - Tuesday
...
**Thoughts:**  
So much turmoil in the world right now.  Riots, police brutality, covid-19, record unemployment...  And all while I have my own pressing priorities.  Going lighter on coding for a bit until things start to straighten out again.

**Link(s) to work:**
1. [FCC: Responsive Web Design: Applied Visual Design - 5 more exercises](https://github.com/BrianLeip/FCC-Responsive-Web-Design/commit/1959411d02a09163c6ab74295ed372ec27a29f26)
2. [Covid-19 Analytics - Updated stats for the day](https://github.com/BrianLeip/Covid19_Analytics/blob/445c3ebf17a62da44a40aa569ecb0206b9da7fba/Covid19_Data_ETL.ipynb)
