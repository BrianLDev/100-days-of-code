...
## R4D39: September 7, 2019 - Saturday
...
**Today's Progress:**  
- **Automate the Boring Stuff with Python**
  - 07 RegEx - tried to get the isPhoneNumber.py regex to work

**Thoughts:**  
Still slammed.  isPhoneNumber.py regex still not working

**Link(s) to work:**
1. [isPhoneNumber.py - attempt to fix regex](https://github.com/BrianLeip/Automate_With_Python/blob/90fbc8f96b60a1ac4399fe565b448baf3397e4c4/07-RegEx/isPhoneNumber.py)
---
...
**Today's Progress:**  
- **Automate the Boring Stuff with Python**
  - 07 RegEx - updated isPhoneNumber.py to use regex.

**Thoughts:**  
Still slammed.  Can't keep doing this forever.

**Link(s) to work:**
1. [isPhoneNumber.py with regex](https://github.com/BrianLeip/Automate_With_Python/blob/913919aacac815cdba78a8b05b5cf4ccb34383db/07-RegEx/isPhoneNumber.py)
---
