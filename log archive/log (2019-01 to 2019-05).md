...
## Day 47: May 11, 2019 - Saturday

**Today's Progress:**  
*ML Bootcamp - day 5 of 8*
- Added Titanic ANN files from Saturday last week
- Added files from Venkat, updated Basic DL, Advanced ML files
- Stock Market Analysis - in class with VT and my partially updated version
- Detect the Criminals ML - in class
- K-Means
- End to End Titanic - Multiple Models - in class work

**Thoughts:**  
Some interesting things in today's session but overall I'm disappointed with this bootcamp.  I'll actually be better off if I were to just go through the Hands on ML book myself (if time permits).  

Getting extremely busy with work now that Manoj is gone and I have to take on all his workload with no additional support staff, so don't have much time to code anymore unfortunately.  Taking a brief break then back at it when things settle down.

**Link(s) to work:**
1. [Added Titanic ANN from Saturday last week](https://github.com/BrianLeip/ML_and_DL_Bootcamp_2019/blob/c147564fda04ee514016913d354e4e1d7b78e3d5/03-Basic%20Deep%20Learning/Titanic%20ANN%20v1%20(2019-BL).ipynb)
2. [Added files from Venkat, updated Basic DL, Advanced ML files](https://github.com/BrianLeip/ML_and_DL_Bootcamp_2019/commit/9c9500ab4d939fc99b044e65907377c4bf00e780)
3. [Stock Market Analysis - in class with VT and my partially updated version](https://github.com/BrianLeip/ML_and_DL_Bootcamp_2019/blob/49f60646fa22aa05f7d33f03c973c84cc31cd5b6/02-Advanced%20ML/Stock_Market_Analysis_(BL).ipynb)
4. [Detect the Criminals ML - in class](https://github.com/BrianLeip/ML_and_DL_Bootcamp_2019/blob/607b2ddf9f81ee17480fa7b31ad0e1200c7a6300/02-Advanced%20ML/Detect_The_Criminals%20(VT-Colab).ipynb)
5. [K-Means](https://github.com/BrianLeip/ML_and_DL_Bootcamp_2019/blob/16f0d643e93e255ca53babd22bc5c693811adc47/02-Advanced%20ML/K_Means_Clustering_(VT_Colab).ipynb)
6. [End to End Titanic - Multiple Models - in class work](https://github.com/BrianLeip/ML_and_DL_Bootcamp_2019/blob/49f60646fa22aa05f7d33f03c973c84cc31cd5b6/02-Advanced%20ML/End_to_End_Titanic_Multiple_Models_(VT_Colab).ipynb)
---
